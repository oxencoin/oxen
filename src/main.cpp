...
#if defined(NDEBUG)
# error "Oxen cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Oxen Signed Message:\n";
...
static const int64_t nTargetTimespan = 5 * 60;  // 60 mins
...
#ifdef ENABLE_WALLET
// oxen: attempt to generate suitable proof-of-stake
